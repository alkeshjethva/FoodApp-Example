...
const NotificationScreen = ({ navigation }) => {
    const [data, setData] = useState(
        [
            ...
            },
            {
                ...
                message: 'To render multiple columns, use the numColumns prop. Using this approach instead ',
                image: require('./images/fourth.png'),
                isSelected: false,
            },
            {
                title: 'Fifth title',
                ...
                message: 'To render multiple columns, use the numColumns prop. Using this approach instead ',
                image: require('./images/fifth.png'),
                isSelected: false,
            }
        ]
    )
    ...
    return (
        <View>
            <HeaderComponent title="Notification" alignItems={'center'} onPressLeft={() => navigation.openDrawer()} />
                                    ...
                                    <TouchableOpacity onPress={() => onPressHandler(data, index)}>
                                        ...
                                        <View style={[styles.listTopView, { backgroundColor: data.isSelected === true ? '#303030' : '#404040' }]}>
                                            ...
                                            <View style={{
                                                ...
                                                <Image source={require('./images/ribbonFill.png')}
                                                    style={{
